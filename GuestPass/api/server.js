...
// Middleware
app.use(cors()); // Added cors middleware explicitly
app.use(express.json());
// app.use(express.static(__dirname)); // Commented out for API-only usage in Vercel
...
if (require.main === module) {
  app.listen(PORT, () => {
    console.log(`\n🚀 FSD City Guest Pass System API`);
