-- FSD City Admin Dashboard - NeonDB Schema
...
INSERT INTO projects (name, status, progress, client, manager, team) VALUES
  ...
  ('FSD City Phase 2', 'Active', 45, 'Direct', 'Sara Khan', 22),
...
INSERT INTO users (name, email, role, location, shift, status) VALUES
  ('Ahmed Ali', 'ahmed.ali@fsdcity.com', 'Security', 'Main Gate', 'Night (8PM-8AM)', 'active'),
  ('Fatima Khan', 'fatima.khan@fsdcity.com', 'Admin', 'HQ Office', 'Day (9AM-5PM)', 'active'),
  ('Bilal Raza', 'bilal.raza@fsdcity.com', 'Site Supervisor', 'Kharian', 'Day (8AM-6PM)', 'active'),
  ('Ayesha Malik', 'ayesha.malik@fsdcity.com', 'HR Coordinator', 'HQ Office', 'Day (9AM-5PM)', 'active'),
  ('Ali Ahmed', 'ali.ahmed@fsdcity.com', 'Site Manager', 'Kharian', 'Day (9AM-6PM)', 'active'),
  ('Sara Khan', 'sara.khan@fsdcity.com', 'Project Manager', 'Phase 2', 'Day (9AM-6PM)', 'active'),
  ('Usman Tariq', 'usman.tariq@fsdcity.com', 'Planning Manager', 'HQ Office', 'Day (9AM-5PM)', 'active')
...
INSERT INTO communications (project, user_name, message, time, unread) VALUES
  ...
  ('FSD City Phase 2', 'Sara Khan', 'Client inspection scheduled for tomorrow', '4 hours ago', 0),
...
INSERT INTO photo_logs (project, location, photos, uploaded_by, time, tags) VALUES
  ...
  ('FSD City Phase 2', 'Main Entrance', 8, 'Site Engineer', '11:45 AM', ARRAY['inspection', 'entrance']),
...
INSERT INTO tasks (title, assignee, project, priority, due, status, completion) VALUES
  ...
  ('Client Presentation Prep', 'Sara Khan', 'FSD City Phase 2', 'High', '2025-10-02', 'In Progress', 75);
...
INSERT INTO payments (vendor, amount, type, due, status, project) VALUES
  ...
  ('Client - Plot A-123', 3000000, 'Receivable', '2025-10-02', 'Confirmed', 'FSD City Phase 2'),
...
INSERT INTO reports (type, project, date, status, downloads) VALUES
  ...
  ('Client Dashboard', 'FSD City Phase 2', '2025-10-01', 'Pending', 0);
...
INSERT INTO client_access (client, project, last_login, reports_viewed, comments, notifications_enabled, status) VALUES
  ...
  ('Direct', 'FSD City Phase 2', '5 hours ago', 8, 2, TRUE, 'Active'),
...
('Muzzamil', 'muzzamil@fsdcity.com', 'Electrician', 'Lahore', 'Active'),
('Sajawal', 'sajawal@fsdcity.com', 'Electrician', 'Lahore', 'Active'),
('Naveed', 'naveed@fsdcity.com', 'Car Maintenance', 'Lahore', 'Active'),
('Allah Ditta', 'allahdditta@fsdcity.com', 'Car Maintenance', 'Lahore', 'Active'),
('Abdul Rehman', 'abdulrehman@fsdcity.com', 'IT Support', 'Islamabad', 'Active'),
('Momin', 'momin@fsdcity.com', 'IT Support', 'Lahore', 'Active'),
('Irfan', 'irfan@fsdcity.com', 'IT Support', 'Lahore', 'Active')
ON CONFLICT (email) DO NOTHING;
