...
INSERT INTO personnel (name, role, phone, email, department, shift, status, specialization, experience_years, location) VALUES
  ('Ahmed Khan', 'Electrician', '+92-300-1234567', 'ahmed.khan@fsdcity.com', 'Maintenance', 'Morning', 'active', 'Electrical Systems, Power Distribution', 8, 'FSD City Plaza'),
  ('Hassan Ali', 'Electrician', '+92-301-2345678', 'hassan.ali@fsdcity.com', 'Maintenance', 'Evening', 'active', 'Lighting Systems, Wiring', 5, 'Faisalabad Office'),
  ('Bilal Ahmad', 'Car Maintenance', '+92-302-3456789', 'bilal.ahmad@fsdcity.com', 'Transportation', 'Morning', 'active', 'Automotive Repair, Vehicle Inspection', 10, 'FSD City Plaza'),
  ('Usman Tariq', 'Car Maintenance', '+92-303-4567890', 'usman.tariq@fsdcity.com', 'Transportation', 'Morning', 'active', 'Mechanical Systems, Car Diagnostics', 7, 'Faisalabad Office'),
  ('Zain Malik', 'IT Support', '+92-304-5678901', 'zain.malik@fsdcity.com', 'IT', 'Morning', 'active', 'Network Administration, Hardware Support', 6, 'FSD City Plaza'),
  ('Imran Sheikh', 'IT Support', '+92-305-6789012', 'imran.sheikh@fsdcity.com', 'IT', 'Evening', 'active', 'Software Support, System Maintenance', 4, 'FSD City Plaza'),
  ('Fatima Noor', 'HR', '+92-306-7890123', 'fatima.noor@fsdcity.com', 'Human Resources', 'Morning', 'active', 'Employee Relations, Compliance', 12, 'FSD City Plaza'),
  ('Ayesha Saleem', 'HR', '+92-307-8901234', 'ayesha.saleem@fsdcity.com', 'Human Resources', 'Morning', 'active', 'Recruitment, Training & Development', 9, 'FSD City Plaza'),
  ('Rashid Mahmood', 'Maintenance', '+92-308-9012345', 'rashid.mahmood@fsdcity.com', 'Maintenance', 'Morning', 'active', 'General Maintenance, Facility Management', 15, 'FSD City Plaza'),
  ('Kamran Javed', 'Maintenance', '+92-309-0123456', 'kamran.javed@fsdcity.com', 'Maintenance', 'Evening', 'active', 'Building Systems, Preventive Maintenance', 11, 'Faisalabad Office'),
  ('Saad Iqbal', 'Plumber', '+92-310-1234567', 'saad.iqbal@fsdcity.com', 'Maintenance', 'Morning', 'active', 'Plumbing Systems, Water Supply', 9, 'FSD City Plaza'),
  ('Farhan Raza', 'HVAC Technician', '+92-311-2345678', 'farhan.raza@fsdcity.com', 'Maintenance', 'Morning', 'active', 'HVAC Systems, Climate Control', 7, 'FSD City Plaza'),
  ('Naveed Ahmed', 'Security Manager', '+92-312-3456789', 'naveed.ahmed@fsdcity.com', 'Security', 'Night', 'active', 'Security Operations, Access Control', 13, 'FSD City Plaza'),
  ('Waqas Hussain', 'Facility Manager', '+92-313-4567890', 'waqas.hussain@fsdcity.com', 'Operations', 'Morning', 'active', 'Facility Planning, Vendor Management', 16, 'FSD City Plaza'),
  ('Tariq Aziz', 'Carpenter', '+92-314-5678901', 'tariq.aziz@fsdcity.com', 'Maintenance', 'Morning', 'active', 'Woodwork, Furniture Repair', 10, 'Faisalabad Office')
...
INSERT INTO properties (id, name, location, description) VALUES
  (1, 'FSD City Plaza', 'Main Boulevard, Faisalabad', 'Commercial property - main plaza'),
...
INSERT INTO personnel_properties (personnel_id, property_id, is_primary, notes) VALUES
  (1, 1, TRUE, 'Primary electrician for FSD City Plaza'),
...
INSERT INTO personnel_properties (personnel_id, property_id, is_primary, notes) VALUES
  (3, 1, TRUE, 'Primary car maintenance for FSD City Plaza fleet'),
  (4, 2, TRUE, 'Primary car maintenance for Faisalabad Office fleet')
ON CONFLICT (personnel_id, property_id) DO NOTHING;

-- IT Support assigned to properties
INSERT INTO personnel_properties (personnel_id, property_id, is_primary, notes) VALUES
  (5, 1, TRUE, 'Primary IT support for FSD City Plaza'),
  (5, 2, FALSE, 'Remote IT support for Faisalabad Office'),
  (6, 1, FALSE, 'Evening shift IT support for FSD City Plaza')
ON CONFLICT (personnel_id, property_id) DO NOTHING;

-- HR assigned to all properties (corporate-wide)
INSERT INTO personnel_properties (personnel_id, property_id, is_primary, notes) VALUES
  (7, 1, TRUE, 'HR Manager for FSD City Plaza'),
  (7, 2, TRUE, 'HR Manager for Faisalabad Office'),
  (8, 1, FALSE, 'HR Coordinator for FSD City Plaza'),
  (8, 2, FALSE, 'HR Coordinator for Faisalabad Office')
ON CONFLICT (personnel_id, property_id) DO NOTHING;

-- Maintenance staff assigned to properties
INSERT INTO personnel_properties (personnel_id, property_id, is_primary, notes) VALUES
  (9, 1, TRUE, 'General maintenance supervisor for FSD City Plaza'),
  (10, 2, TRUE, 'General maintenance supervisor for Faisalabad Office'),
  (11, 1, TRUE, 'Primary plumber for FSD City Plaza'),
  (12, 1, TRUE, 'Primary HVAC technician for FSD City Plaza'),
  (13, 1, TRUE, 'Security manager for FSD City Plaza'),
  (14, 1, TRUE, 'Facility manager for FSD City Plaza'),
