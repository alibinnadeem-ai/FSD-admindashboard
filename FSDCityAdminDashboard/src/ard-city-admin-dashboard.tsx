...
const ARDCityAdmin = () => {
  ...
  const [projects, setProjects] = useState([
    ...
    { id: 2, name: 'FSD City Phase 2', status: 'Active', progress: 45, client: 'Direct', manager: 'Sara Khan', team: 22 },
  ...
  const [communications, setCommunications] = useState([
    ...
    { id: 2, project: 'FSD City Phase 2', user: 'Sara Khan', message: 'Client inspection scheduled for tomorrow', time: '4 hours ago', unread: 0 },
  ...
  const [photoLogs, setPhotoLogs] = useState([
    ...
    { id: 2, project: 'FSD City Phase 2', location: 'Main Entrance', photos: 8, uploadedBy: 'Site Engineer', time: '11:45 AM', tags: ['inspection', 'entrance'] },
  ...
  const [tasks, setTasks] = useState([
    ...
    { id: 4, title: 'Client Presentation Prep', assignee: 'Sara Khan', project: 'FSD City Phase 2', priority: 'High', due: '2025-10-02', status: 'In Progress', completion: 75 },
  ]);
  ...
  const [payments, setPayments] = useState([
    ...
    { id: 2, vendor: 'Client - Plot A-123', amount: 3000000, type: 'Receivable', due: '2025-10-02', status: 'Confirmed', project: 'FSD City Phase 2' },
  ...
  const [reports, setReports] = useState([
    ...
    { id: 3, type: 'Client Dashboard', project: 'FSD City Phase 2', date: '2025-10-01', status: 'Pending', downloads: 0 },
  ]);
  ...
  const [clientAccess, setClientAccess] = useState([
    ...
    { id: 2, client: 'Direct', project: 'FSD City Phase 2', lastLogin: '5 hours ago', reportsViewed: 8, comments: 2, notificationsEnabled: true, status: 'Active' },
    ...
    <div className="min-h-screen bg-gray-50 p-4 md:p-6">
      ...
      <div className="mb-6">
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4 mb-2">
          <div>
            <h1 className="text-2xl md:text-3xl font-bold text-gray-900">FSD City HQ</h1>
