...
export default function Users() {
  ...
  const [empShift, setEmpShift] = useState('Day (10AM-6PM)');
    ...
    try {
      const response = await fetch('/api/users', {
        ...
        body: JSON.stringify({
          ...
          shift: empShift.trim() || 'Day (10AM-6PM)',
          ...
          <div className="relative bg-white w-full max-w-md rounded-lg shadow p-6">
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <input value={empEmail} onChange={(e) => setEmpEmail(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded" placeholder="e.g., ahmed.ali@fsdcity.com" />
              </div>
