...
// GET /api/users - Fetch all users/personnel (legacy-compatible route name)
...
// POST /api/users - Create a new user/personnel record
...
// PATCH /api/users?id=<id> - Update user/personnel
...
// DELETE /api/users?id=<id> - Delete user/personnel
